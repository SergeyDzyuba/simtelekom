            ...
            success: function (data) {
                ...
                if (data !== 'false') {
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        var phone = rows[i]['client_mobile_phone'];
                        var cur_location = window.location.origin+window.location.pathname;
                        var link = cur_location+'?module=Contacts&action=DetailView&record=' + contact_id+'&openAppealSubpanel=1&phone='+phone+'&chat_id='+chat_id;
