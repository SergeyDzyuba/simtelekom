 ...
 * PLACE ANY CUSTOMIZATIONS IN C0704_Agents
 */

require_once('include/SugarObjects/templates/person/Person.php');

class C0704_Agents_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'C0704_Agents';
	var $object_name = 'C0704_Agents';
	var $table_name = 'c0704_agents';
