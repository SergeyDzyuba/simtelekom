 ...
 * PLACE ANY CUSTOMIZATIONS IN CCU2_Agents2
 */

require_once('include/SugarObjects/templates/person/Person.php');

class CCU2_Agents2_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'CCU2_Agents2';
	var $object_name = 'CCU2_Agents2';
	var $table_name = 'ccu2_agents2';
	var $importable = true;
