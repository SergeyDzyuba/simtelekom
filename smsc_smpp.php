<?php // SMSC.RU API (smsc.ru) версия 1.3 (20.10.2014)

define("SMSC_HOST", "192.168.104.36");	// адрес SMPP-сервера
define("SMSC_PORT", 2775);				// порт подключения
define("SMSC_LOGIN", "crm");		// логин клиента
define("SMSC_PASSWORD", "117crm");	// пароль
