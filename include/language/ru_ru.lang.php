...
$app_strings = array (
    'LBL_SUBPANEL_CONTACT_APPEALS_TITLE' => 'Обращения',
  ...
  'LBL_JS_CALENDAR' => 'Календарь' /*for 508 compliance fix*/,
   ...
   'LBL_EMAIL_ADDRESS_BOOK_ADD'			    => 'Готово',
    ...
    'LBL_ADDRESS_APARTMENT' => '№ Квартиры',
    'LBL_ADDRESS' => 'Основной адрес',
    ...
    'ERROR_FULLY_EXPIRED'=> 'Ваша лицензия заканчивается через 7 дней и должна быть обновлена. Только администраторы могут войти в систему.' ,
